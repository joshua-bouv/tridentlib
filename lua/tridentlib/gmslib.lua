	...
	hook.Add("HUDPaint",name,function()
		if IsValid(self) then
			...
			if return_version-version >= 5 then
				draw.RoundedBox(0,x,y+h+lerp_pos-60,w,lerp_goto,redText)
				...
				if version < return_version then
					draw.RoundedBox(0,x,y+h+lerp_pos-60,w,lerp_goto,Color(251,192,45))
					...
					draw.RoundedBox(0,x,y+h+lerp_pos-60,w,lerp_goto,greenText)
